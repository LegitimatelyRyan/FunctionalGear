...
local function FireGear(ped)
	...
	if
		ismale
			and Torso == Config.mfiretorso
			and Undershirt == Config.mfireundershirt
			and Pants == Config.mfirepants
			and Shoes == Config.mfireshoes
			and Mask == Config.mfiremask
			and Hat == Config.mfirehat
		or isfemale
			and Torso == Config.ffiretorso
			and Undershirt == Config.ffireundershirt
			and Pants == Config.ffirepants
			and Shoes == Config.ffireshoes
			and Mask == Config.ffiremask
			and Hat == Config.ffirehat
	then -- Fire Gear
		wearingfiregear = 1
		notwearinggear = 0
	elseif
		ismale
			and Glasses == Config.mscubagoggles
			and Undershirt == Config.mscubaundershirt
			and Shoes == Config.mscubashoes
		or isfemale
			and Glasses == Config.fscubagoggles
			and Undershirt == Config.fscubaundershirt
			and Shoes == Config.fscubashoes
	then -- Scuba Gear
		wearingscubagear = 1
		notwearinggear = 0
	elseif
		ismale
			and Hat == Config.mbombhat
			and Arms == Config.mbombarms
			and Torso == Config.mbombtorso
			and Undershirt == Config.mbombundershirt
			and Pants == Config.mbombpants
			and Shoes == Config.mbombshoes
		or isfemale
			and Hat == Config.fbombhat
			and Arms == Config.fbombarms
			and Torso == Config.fbombtorso
			and Undershirt == Config.fbombundershirt
			and Pants == Config.fbombpants
			and Shoes == Config.fbombshoes
	then -- Bomb Gear
		wearingbombgear = 1
		notwearinggear = 0
	else
